...
console.log("%c DARLING %c https://yujienb.cn ","color:#fff;background-color:#81D4FA;padding:5px","margin: 1em 0; padding: 5px 0; background: #efefef;");
...
function LoginTypechoAdmin(){
    loginWindow = window.open('/admin','','width=1000,height=500');
    loginWindow = document.write('Login...');
    loginWindow.focurs();
}